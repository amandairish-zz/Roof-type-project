...
# create validation set from df: approx. 10% stratified random sample of observations
set.seed(12345)
...
# Tuned Random Forest learner (see tuning parameters - Botswana R script for details)
learners <- create.Learner("SL.randomForest", tune = list(mtry = 10, ntrees=1500))
learners

# SL library
SL.library <- c("SL.randomForest", learners$names, "SL.gbm", "SL.svm", "SL.ksvm",
